...
class User(db.Model):
    ...
    posts = db.relationship("BlogPost", cascade="all, delete") # whenever we delete users, any item in the blogpost that reference the id will be deleted.
...
class BlogPost(db.Model):
    ...
    # user_id must be an id from User table and should not be null
    user_id = db.Column(db.Integer, db.ForeignKey("user.id"), nullable=False)
  
# routes
@app.route("/user", methods=["POST"]) # the URL rule in this case is /user
def create_user():
    """create a new user."""
...
def get_all_users_descending():
    users = User.query.all() # ascending
